...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $api_key ; ?>&libraries=geometry"></script>
<script src="./polylineWidth.js"></script>
<div id="map"></div>
<style>
    div#map {
        width:500px ;
...
<script>
  ...
  jQuery(document).ready(function(){
    ...
    var polyWidth = new polylineWidth({
      map : map,
      path: path,
      strokeColor: '#FF0000',
      strokeOpacity: 1.0,
